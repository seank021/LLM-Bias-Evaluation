...
# Extract responses from the model (Llama3 8B)
output = []
...
# Save to result/us.json
result_dir = "result"
os.makedirs(result_dir, exist_ok=True)
output_file = os.path.join(result_dir, "us.json")
