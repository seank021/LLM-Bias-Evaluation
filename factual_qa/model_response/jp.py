...
# Extract responses from the model (Baichuan2 7B)
output = []
...
# Save to result/jp.json
result_dir = "result"
os.makedirs(result_dir, exist_ok=True)
output_file = os.path.join(result_dir, "jp.json")
